...
**Current focus: Phase 2, R4.** The Phase-1 table above is the historical record — M0–M6 are closed out and their residual open items fold into R6 (or are logged in §7). Work R1 → R6, then M7–M9.
